                ...
                <div id="client" >
                    ...
                    <?php   if(($invoice->billing_name!=null)&&!empty(trim($invoice->billing_name))){
                        ...
                        if ($invoice->billing_name) {
                            $str = $invoice->billing_name; 
                            $strn = str_replace('���','', $str); 
                            echo '<div style="text-transform: uppercase">' . htmlsc($strn) . '</div>';
                        }
...
<?php if($invoice->invoice_paid > 0){ ?>
    <tr>
    <td colspan="2" style="border-left:1px solid black;"></td>
        <td <?php echo($show_item_discounts ? 'colspan="5"' : 'colspan="1"'); ?> class="text-right" style="border-top:1px solid black;border-left:1px solid black;">
            <?php _trans('paid'); ?>
        </td>
