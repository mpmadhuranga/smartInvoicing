        ...
        <tr>
            ...
            <th scope="col" style="">
                <div class="invoice-details clearfix">
                    <table>
                        <tr>
                            <td class="text-red" style="text-align:left;"><?php echo trans('Invoice No') . ':'; ?></td>
                            <td class="text-red" style="text-align:left;"><?php echo $invoice->invoice_number ? $invoice->invoice_number : $invoice->invoice_id; ?></td>
                        </tr>
                        <tr>
                            <td class="text-red" style="text-align:left;"><?php echo trans('invoice_date') . ':'; ?></td>
                                  <td class="text-red" style="text-align:left;"><?php echo date("d/m/20y", strtotime(date_from_mysql($invoice->invoice_date_created, true))); ?></td>
                    
                            <!--<td class="text-red" style="text-align:left;"><?php echo date_from_mysql($invoice->invoice_date_created, true); ?></td>-->
                        </tr>
                        <tr>
                            <td class="text-red" style="text-align:left;"><?php echo trans('due_date') . ': '; ?></td>
                              <td class="text-red" style="text-align:left;"><?php echo date("d/m/20y", strtotime(date_from_mysql($invoice->invoice_date_due, true)));  ?></td>
                      
                            <!--<td class="text-red" style="text-align:left;"><?php echo date_from_mysql($invoice->invoice_date_due, true); ?></td>-->
                        </tr>
                        <tr>
                            <td class="text-red" style="text-align:left;"><b><?php echo trans('amount_due') . ': '; ?></b></td>
                            <td class="text-red" style="text-align:left;"><b><?php echo format_currency($invoice->invoice_balance); ?></b></td>
                        </tr>
                        <!-- <tr>
...
<?php if($invoice->invoice_paid > 0){ ?>
    <tr>
    <td colspan="2" style="border-left:1px solid #636262;"></td>
        <td <?php echo($show_item_discounts ? 'colspan="5"' : 'colspan="1"'); ?> class="text-right" style="border-top:1px solid #636262;border-left:1px solid #636262;">
            <?php _trans('paid'); ?>
        </td>
        <td class="text-right" style="border-right:1px solid #636262;border-top:1px solid #636262;">
            ...
            <th scope="col" style="">
                <div class="invoice-details clearfix">
                    <table>
                        ...
                        <tr>
                            <td class="text-red" style="text-align:left;"><?php echo trans('amount_due') . ': '; ?></td>
                            <td class="text-red" style="text-align:left;"><?php echo format_currency($invoice->invoice_balance); ?></td>
                        </tr>
                        <!-- <tr>
                <td><?php echo trans('due_date') . ': '; ?></td>
                <td><?php echo date_from_mysql($invoice->invoice_date_due, true); ?></td>
