...
<h3 class="report_title">
  ...
  <?php echo date("d/m/20y", strtotime($from_date )). ' - ' .date("d/m/20y", strtotime($to_date ))  ?>
...
<table>
    ...
    foreach ($results as $result) {
        ...
        <tr>
            <td>
                  <?php echo date("d/m/20y", strtotime(date_from_mysql($result->payment_date, true)));  ?>
             
                <!--<?php echo date_from_mysql($result->payment_date, true); ?>-->
