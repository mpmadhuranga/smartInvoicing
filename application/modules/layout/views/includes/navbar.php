<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div style="color: rgba(255,255,255,1);font-weight: bolder; padding-top: 2px; float: left; background-color: #740001; padding: 5px">
                OUR TIMES <br> <span style="font-weight: normal !important;">Liquor and Beverages</span></div>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-md"><?php _trans('Members'); ?></span>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><?php echo anchor('suppliers/form', trans('Add Suppliers')); ?></li>
                    <li><?php echo anchor('suppliers/index', trans('View suppliers')); ?></li>
                </ul>
            </li>
            ...
            <!--                    <ul class="dropdown-menu">-->
            <!--                        <li>-->
            <?php //echo anchor('suppliers/form', trans('add_client')); ?><!--</li>-->
            <!--                        <li>-->
            <?php //echo anchor('suppliers/index', trans('view_clients')); ?><!--</li>-->
            <!--                    </ul>-->
            <!--                </li>-->
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="fa fa-caret-down"></i> &nbsp;
                    <span class="hidden-md"><?php _trans('invoice'); ?></span>
...
<!--                    <li><a href="#" class="create-supplier_invoice">--><?php //_trans('create_supplier_invoice'); ?><!--</a></li>-->
<!--                    <li>--><?php //echo anchor('supplier_invoices/index', trans('view_supplier_invoices')); ?><!--</li>-->

                    <!--                        <li>-->
                    <?php //echo anchor('invoices/recurring/index', trans('view_recurring_invoices')); ?><!--</li>-->
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <!--                        <li>-->
                    <?php //echo anchor('payments/online_logs', trans('view_payment_logs')); ?><!--</li>-->
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><?php echo anchor('stock/form', trans('Add Stock')); ?></li>
                    <li><?php echo anchor('stock/index', trans('View Stock')); ?></li>
                    <li><?php echo anchor('families/index', trans('product_families')); ?></li>
                    <li><?php echo anchor('units/index', trans('product_units')); ?></li>
                    <li><?php echo anchor('clients/formcpc', trans('assign_client_price')); ?></li>
                    <li><?php echo anchor('clients/statusproduct', trans('view_client_price')); ?></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><?php echo anchor('reports/invoice_by_date', trans('invoice_by_date')); ?></li>
                    <li><?php echo anchor('reports/overdue_invoice_by_date', 'Overdue Invoices'); ?></li>
                    <li><?php echo anchor('reports/profit_report', trans('profit_report')); ?></li>
                    <li><?php echo anchor('reports/profit_report_new', trans('profit_report_new')); ?></li>
                    <li><?php echo anchor('reports/inventory_report', trans('inventory_report')); ?></li>
                    <li><?php echo anchor('reports/stock_report', trans('stock_report')); ?></li>
                    
                    <!--<li><?php echo anchor('reports/credit_note', trans('Add Credit Note')); ?></li>-->
                    <!-- <li><?php echo anchor('reports/view_credit_notes', trans('view_credit_notes')); ?></li>-->
                </ul>
            </li>
             ...
             <li class="dropdown <?php echo get_setting('projects_enabled') == 1 ?: 'hidden'; ?>">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="fa fa-caret-down"></i> &nbsp;
                    <span class="hidden-md"><?php _trans('cheque'); ?></span>
                    <i class="visible-md-inline fa fa-check-square-o"></i>
                </a>
                <ul class="dropdown-menu">
                    <li><?php echo anchor('cheque/form', trans('add_cheque')); ?></li>
                    <li><?php echo anchor('cheque/index', trans('view_cheque')); ?></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><?php echo anchor('invoices/archive', trans('invoice_archive')); ?></li>
                                            ...
                                            <li>
                    <?php //echo anchor('item_lookups/index', trans('item_lookups')); ?></li>-->
    ...
    <div class="collapse navbar-collapse" id="ip-navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="fa fa-caret-down"></i> &nbsp;
                    <span class="hidden-md"><?php _trans('reports'); ?>
</span>
                    <i class="visible-md-inline fa fa-bar-chart"></i>
                </a>
                <ul class="dropdown-menu">
...
<!--            </a>-->
<!--        </li>-->
        <!--<li><?php //echo anchor('guest', trans('dashboard'), 'class="hidden-md"') ?>-->
        <!--    <?php //echo anchor('guest', '<i class="fa fa-dashboard"></i>', 'class="visible-md-inline-block"') ?>-->
        <!--</li>-->
        <!--<li><?php //echo anchor('guest/invoices/index', trans('invoices'), 'class="hidden-md"') ?>-->
        <!--    <?php //echo anchor('guest/invoices/index', '<i class="fa fa-dashboard"></i>', 'class="visible-md-inline-block"') ?>-->
        <!--</li>-->
        <!--<li><?php //echo anchor('guest/payments/index', trans('payments'), 'class="hidden-md"') ?>-->
        <!--    <?php //echo anchor('guest/payments/index', '<i class="fa fa-dashboard"></i>', 'class="visible-md-inline-block"') ?>-->
        <!--</li>-->
        
        <li><?php echo anchor('', trans('dashboard'), 'class="hidden-md"') ?>
            <?php echo anchor('', '<i class="fa fa-dashboard"></i>', 'class="visible-md-inline-block"') ?>
        </li>
        <li><?php echo anchor('invoices/index', trans('invoice'), 'class="hidden-md"') ?>
            <?php echo anchor('invoices/index', '<i class="fa fa-dashboard"></i>', 'class="visible-md-inline-block"') ?>
        </li>
        <li><?php echo anchor('payments/index', trans('payments'), 'class="hidden-md"') ?>
            <?php echo anchor('payments/index', '<i class="fa fa-dashboard"></i>', 'class="visible-md-inline-block"') ?>
        </li>
