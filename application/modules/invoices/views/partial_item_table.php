...
<!--                    <span class="input-group-addon">--><?php //_trans('product_sku'); ?><!--</span>-->
<!--                    <input type="text" name="item_sku" class="input-sm form-control" value="" readonly>-->
<!--                </div>-->
<!--            </td>-->
            <td class="td-text">
...
<!--                    <span class="input-group-addon">--><?php //_trans('item'); ?><!--</span>-->
                    <input type="text" name="item_name" class="input-sm form-control" value="" readonly>
                </div>
            </td>
            <td class="td-amount td-quantity">
                <div class="input-group">
<!--                    <span class="input-group-addon">--><?php //_trans('quantity'); ?><!--</span>-->
                    <input type="text" name="item_quantity" id="item_quantity" class="input-sm form-control amount" value="">
                </div>
            </td>
            <td class="td-amount">
                <div class="input-group">
...
<tr style="border-top: 0">
    <th></th>
    <th><?php _trans('item'); ?> / <?php _trans('description'); ?></th>
    <th><?php _trans('quantity'); ?></th>
    <th><?php _trans('price'); ?></th>
...
<!--                        <span class="input-group-addon">--><?php //_trans('price'); ?><!--</span>-->
                        <input type="text" name="item_price" class="input-sm form-control amount"
                               ...
                               <?php if ($invoice->is_read_only == 1 || $this->session->userdata('user_type') != 1) {
                                echo 'disabled="disabled"';
                            } ?>>
                    </div>
                </td>
...
<!--                            <span class="input-group-addon">--><?php //_trans('description'); ?><!--</span>-->
                            <textarea name="item_description"
                                ...
                                <?php if ($invoice->is_read_only == 1) {
                                    echo 'disabled="disabled"';
                                } ?> readonly><?php echo htmlsc($item->item_description); ?></textarea>
                        </div>
                    </td>
                <?php else: ?>
                    <td class="td-date">
                        <div class="input-group">
                            <span class="input-group-addon"><?php _trans('date'); ?></span>
                            <input type="text" name="item_date" class="input-sm form-control datepicker"
                                   value="<?php echo date_from_mysql($item->item_date); ?>"
                                <?php if ($invoice->is_read_only == 1) {
                                    echo 'disabled="disabled"';
                                } ?>>
                        </div>
