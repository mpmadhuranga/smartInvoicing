...
<!-- start admin permission -->
        <?php if ($invoice->is_read_only != 1 || $invoice->invoice_status_id != 4 && $invoice->invoice_status_id != 2 && $invoice->invoice_status_id != 6 || $this->session->userdata('user_type') == 1) { ?>
			...
			class="btn btn-sm btn-success ajax-loader" id="btn_save_invoice"> <i
...
<div id="content">
  ...
  <td>
 <table>
<tr><b>Billing Address</b></tr>


 
 <tr><td> Company Name<input id="billing_name_1" value="<?php
...
<?php if((strlen($invoice->client_name)>29)&&($invoice->billing_name==null)){  ?>
  <tr><td style="padding-top:3px;"> <input id="billing_name_2" value="<?php
...
<?php }else if((strlen($invoice->billing_name)>29)&&!($invoice->billing_name==null)){ ?>
 ...
 <tr><td> Street Address 1<input id="billing_st_1" value="<?php
 ...
 if(($invoice->billing_st_1!=null)&&!empty(trim($invoice->billing_st_1))){
    ...
    ?>"style="width:270px;"  type="text" class="form-control " /><td></tr>
 <tr><td> Street Address 2<input id="billing_st_2" value="<?php
 ...
 ?>" style="width:270px;"  type="text" class="form-control " /><td></tr>
 <tr><td> City<input type="text" id="billing_city" value="<?php
 ...
 ?>" style="width:270px;"  class="form-control " /><td></tr>
...
<tr><b  style="margin-left:75px;">Delivery Address</b></tr>


 <tr><td> Name<input id="deliver_name_1" value="<?php
...
<?php if((strlen($invoice->client_name)>29)&&($invoice->deliver_name==null)){  ?>
  <tr><td style="padding-top:3px;"> <input id="deliver_name_2" value="<?php
...
<?php }else if((strlen($invoice->deliver_name)>29)&&!($invoice->deliver_name==null)){ ?>
 ...
 <tr><td> Street Address 1<input id="deliver_st_1" value="<?php
 ...
 if(($invoice->deliver_st_1!=null)&&!empty(trim($invoice->deliver_st_1))){
    ...
    ?>"style="width:270px;"  type="text" class="form-control " /><td></tr>
 <tr><td> Street Address 2<input id="deliver_st_2" value="<?php
 ...
 ?>" style="width:270px;"  type="text" class="form-control " /><td></tr>
 <tr><td> City<input type="text" id="deliver_city" value="<?php
 ...
 ?>" style="width:270px;"  class="form-control " /><td></tr>
				...
				<div
					class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-6 col-md-offset-1">
                            ...
                            <div class="col-xs-12 col-md-6">
								...
								<div class="invoice-properties">
									<label><?php _trans('invoice'); ?> #</label> <input type="text"
										id="invoice_number" class="form-control input-sm"
