...
<div id="content">
    ...
    <div
		class="row <?php if (get_setting('disable_quickactions') == 1) echo 'hidden'; ?>">
		<div class="col-xs-12">
			...
			<div id="panel-quick-actions"
				...
				<div class="btn-group btn-group-justified no-margin">
					<a href="<?php echo site_url('clients/form'); ?>"
						class="btn btn-default"> <i class="fa fa-user fa-margin"></i> <span
						class="hidden-xs"><?php _trans('add_client'); ?></span>
					</a> <a href="javascript:void(0)"
						class="create-quote btn btn-default"> <i
						class="fa fa-file fa-margin"></i> <span class="hidden-xs"><?php _trans('create_quote'); ?></span>
					</a> <a href="javascript:void(0)"
						class="create-invoice btn btn-default"> <i
						class="fa fa-file-text fa-margin"></i> <span class="hidden-xs"><?php _trans('create_invoice'); ?></span>
					</a> <a href="<?php echo site_url('payments/form'); ?>"
						class="btn btn-default"> <i class="fa fa-credit-card fa-margin"></i>
						<span class="hidden-xs"><?php _trans('enter_payment'); ?></span>
					</a> <a href="<?php echo site_url('clients/formcpc'); ?>"
						class="btn btn-default"> <i class="fa fa-product-hunt fa-margin"></i>
						<span class="hidden-xs"><?php _trans('assign_client_price'); ?></span>
					</a>
				</div>
...
<?php echo $total['label']; ?>
		...
		<div class="col-xs-12 col-md-6">
					...
					<table class="table table-striped table-condensed no-margin">
                        ...
                        foreach ($invoices as $invoice) {
                            ...
                            <tr>
								...
								<span style="background-color: #c5635c" class="label <?php echo $invoice_statuses[$invoice->invoice_status_id]['class']; ?>">
                            ...
                            if ($invoice->is_read_only == 1) {
                                ?>
                                            &nbsp;<i
										class="fa fa-read-only" title="<?php _trans('read_only') ?>"></i>
                                        <?php }; ?>
                                    </span></td>
								<td>
								    <span
									class="<?php if ($invoice->is_overdue) { ?>font-overdue<?php } ?>">
								...
								<td style="text-align: center;">
                                    <?php if ($invoice->sumex_id != null): ?>
                                        <a
									href="<?php echo site_url('invoices/generate_sumex_pdf/' . $invoice->invoice_id); ?>"
									title="<?php _trans('download_pdf'); ?>"> <i
										class="fa fa-file-pdf-o"></i>
								</a>
                                    <?php else: ?>
                                        <a
									href="<?php echo site_url('invoices/generate_pdf/' . $invoice->invoice_id); ?>"
									title="<?php _trans('download_pdf'); ?>"> <i
										class="fa fa-file-pdf-o"></i>
								</a>
                                    <?php endif; ?>
			...
			<div id="panel-recent-invoices" class="panel panel-default">
				...
				<div class="panel-heading">
					<b><i class="fa fa-check-square-o fa-margin"></i> <?php _trans('notifications'); ?></b>
				</div>

				<div class="table-responsive" style="height: 375px !important;">
					<table class="table table-striped table-condensed no-margin">

						<thead>
							<tr>
								<th><?php _trans('pro_name'); ?></th>
								<th><?php _trans('rem_bal'); ?></th>
							</tr>
						</thead>
            ...
            ?>
                                <tr>
                                    ...
                                    <td style="width: 400px;">
                                        <?php echo anchor('products/form/' . $st->pid, htmlsc($st->productname));?>
                                    </td>
	...
	<div class="row">
		...
		<!---->
		<!--                <div class="panel-heading">-->
		<!--                    <b><i class="fa fa-history fa-margin"></i> -->
				<?php //_trans('recent_quotes'); ?>
				<!--</b>-->
		<!--                </div>-->
		<!--                <div class="table-responsive">-->
		<!--                    <table class="table table-striped table-condensed no-margin">-->
...
<!--                                </td>-->
		<!--                                <td style="text-align: center;">-->
		<!--                                    <a href="-->
				<?php //echo site_url('quotes/generate_pdf/' . $quote->quote_id); ?>
				<!--"-->
		<!--                                       title="-->
...
<!--                            </td>-->
		...
		<!--        </div>-->
			...
			<div id="panel-recent-invoices" class="panel panel-default">
				...
				<div class="panel-heading">
					<b><i class="fa fa-check-square-o fa-margin"></i> <?php _trans('quote_short'); ?></b>
				</div>
        ...
        foreach ($short as $sh) {
            $stock_qty = $sh->qty;
            $real_qty=$sh->mq;
            $qty=$stock_qty-$real_qty;
            ?>
                                <tr>
                                    <?php //if($real_qty>$st_qty){?>
                                    <td style="width: 400px;">
                                        <?php echo anchor('products/form/' . $st->pid, htmlsc($sh->productname));?>
                                    </td>
								<td style="color: red !important;">
									<!--                                       -->
											<?php //echo htmlsc($qt); ?>
    ...
    <?php if (get_setting('projects_enabled') == 1) : ?>
		...
		<!---->
		<!--                    <div class="panel-heading">-->
		<!--                        <b><i class="fa fa-list fa-margin"></i> -->
				<?php //_trans('projects'); ?>
				<!--</b>-->
		<!--                    </div>-->
		<!--                    <div class="table-responsive">-->
					...
					<table class="table table-striped table-condensed no-margin">
						...
						<tbody>
                            <?php //foreach ($tasks as $task) { ?>
                                <tr>
								<td><span
									class="label <?php //echo $task_statuses["$task->task_status"]['class']; ?>">
								...
								<td><span
									class="<?php //if ($task->is_overdue) { ?>text-danger<?php //} ?>">
