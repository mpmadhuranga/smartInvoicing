    ...
    public function index()
    {
        ...
        $this->layout->set(
            array(
                ...
                'invoices' => $this->mdl_invoices->dashboard_invoice(),
                ...
                'stock' => $this->mdl_invoices->product_notif(),
                'short' => $this->mdl_invoices->quote_notif(),
                'stock_statuses' => $this->mdl_invoices->stat(),
            )
        );
