...
<div id="headerbar">
    ...
    <div class="headerbar-item pull-right">
        <div class="btn-group btn-group-sm">
            ...
            <a href="<?php echo site_url('stock/form/' . $supplier->supplier_id); ?>"
               class="btn btn-default">
                <i class="fa fa-edit"></i> <?php _trans('edit'); ?>
            </a>
            <a class="btn btn-danger"
               href="<?php echo site_url('stock/delete/' . $supplier->supplier_id); ?>"
                        ...
                        <div class="panel-body table-content">
                            <table class="table no-margin">
                                ...
                                <?php if ($supplier->supplier_address_1) : ?>
                                    <tr>
                                        <th><?php _trans('email'); ?></th>
                                        <td><?php _auto_link($supplier->supplier_address_1, 'email'); ?></td>
                                    </tr>
                                <?php endif; ?>
                                    <?php if ($supplier->supplier_address_2) : ?>
                                    <tr>
                                        <th><?php _trans('email'); ?></th>
                                        <td><?php _auto_link($supplier->supplier_address_2, 'email'); ?></td>
                                    </tr>
                                <?php endif; ?>
                                    ...
                                    <tr>
                                        <th><?php _trans('email'); ?></th>
                                        <td><?php _auto_link($supplier->supplier_city, 'email'); ?></td>
                                    </tr>
                                <?php endif; ?>
                                    ...
                                    <tr>
                                        <th><?php _trans('email'); ?></th>
                                        <td><?php _auto_link($supplier->supplier_state, 'email'); ?></td>
                                    </tr>
                                <?php endif; ?>
                                     <?php if ($supplier->supplier_zip) : ?>
                                    <tr>
                                        <th><?php _trans('email'); ?></th>
                                        <td><?php _auto_link($supplier->supplier_zip, 'email'); ?></td>
                                    </tr>
                                      <?php endif; ?>
