...
//        });
 ...
 function abc(){
        var pro = $('#stock_product_id').val();
        var sup = $('#stock_suppliers_id').val();
        var qty = $('#stock_open_qty').val();
        if(pro!=0 && sup!=0 && qty!=""){
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="panel-body">
                <label for="create_invoice_client_id"><?php _trans('Product'); ?></label>
                <div class="input-group">
<!--                     <select name="stock_product_id" id="stock_product_id" class="product-id-select form-control" -->
<!--                             autofocus="autofocus"> -->
...
<!--                     </select> -->
      ...
      <!--                      </select>-->
                            ...
                            <select onchange="abc()" name="stock_product_id" id="stock_product_id" class="form-control simple-select">
                                <option value="0"><?php _trans('select_product'); ?></option>
                                <?php 
...
<!--                                        --><?php //check_select($this->mdl_pro->result_with_qty('client_name'),  $product->product_name); ?>
                          ...
                          <input class="hidden" id="input_permissive_search_suppliers"
                   value="">
...
<!--                             <option value=""></option> -->
                        <?php //endif; ?>
<!--                     </select> -->
                    <select onchange="abc()" name="stock_suppliers_id" id="stock_suppliers_id"
						class="form-control simple-select">
...
<div class="panel-body">
						<div class="form-group">
							<label for="Quantity"><?php _trans('buyp'); ?></label>

							<div class="controls">
								<input type="text" name="stock_bp" id="stock_bp"
									class="form-control">
							</div>
						</div>
					</div>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input onkeyup="abc()" type="text" name="stock_open_qty" id="stock_open_qty" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
