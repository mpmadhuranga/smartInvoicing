...
<form method="post">
	...
	<div id="headerbar">
		<h1 class="headerbar-title"><?php _trans('chequeeditform'); ?></h1>
			...
			<div class="col-xs-12 col-sm-6">
				...
				<div class="panel panel-default">
					...
					<input class="hidden" id="input_permissive_search_products"
						...
						<input class="hidden" id="cheque_id" name="cheque_id" value="<?php echo $checkid;?>">
...
<div class="panel-body">
						<div class="form-group">
							...
							<div class="input-group">
								<input value="<?php echo date($addedate);?>" required="" name="from_date" id="from_date"
                    ...
                    <div class="panel-body">
						<div class="form-group">
							...
							<div class="controls">
								<input value="<?php echo $amount;?>" onkeyup="abc()" type="text" name="amount"
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="controls">
								<input value="<?php echo $checkno;?>" onkeyup="abc()" type="text" name="chequeno"
