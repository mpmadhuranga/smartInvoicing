...
<div class="table-responsive">
    <table id="quotb" class="table table-striped">
        ...
        foreach ($quotes as $quote) {
            ...
            <tr>
                ...
                <td>
                    	...
                    	<?php echo date("d/m/20y", strtotime(date_from_mysql($quote->quote_date_created, true)));  ?>
                    
                    <!--<?php echo date_from_mysql($quote->quote_date_created); ?>-->
                </td>
                <td>
                    <?php echo date("d/m/20y", strtotime(date_from_mysql($quote->quote_date_expires, true)));  ?>
