<script>
    function abc(){
        ...
        var minq = $('#minQuantity').val();
        var maxq = $('#maxQuantity').val();
        if(fromdate=="" && todate=="" && minq=="" && maxq==""){
...
target="_blank">
                        ...
                        <div class="clearfix">
                            <div class="col-xs-12 col-md-2" style="margin-right:10px; padding-left:0px;">
                                ...
                                <div>
                                    <input required="" type="number" id="minQuantity" name="minQuantity" min="0"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-md-2" style=padding-left:0px;>
                                ...
                                <div>
                                    <input required="" type="number" id="maxQuantity" name="maxQuantity" min="0"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
