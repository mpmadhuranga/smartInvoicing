...
{
    $CI = &get_instance();
if($CI->$model->total_rows > 15) {
    $pager = '<div class="pagination-container">';
    $pager .= '<div class="page-details col-md-5">' . ($CI->$model->offset + 1) . ' - ' . $CI->$model->next_offset . ' of ' . $CI->$model->total_rows;
    $pager .= '</div> <div class="col-md-5 page-buttons-container"><div class="page-buttons-details model-pager btn-group btn-group-sm md-col-6">';
